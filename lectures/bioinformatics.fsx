(**
// can't yet format YamlFrontmatter (["title: WPB IX - Embracing bioinformatics with FSharp"; "category: Lecture material"; "categoryindex: 1"; "index: 9"], Some { StartLine = 1 StartColumn = 0 EndLine = 5 EndColumn = 8 }) to pynb markdown
