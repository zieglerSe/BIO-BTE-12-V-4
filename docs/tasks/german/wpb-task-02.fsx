...
# Task02 ñ Functions and Data types
...
Bei Record Types wird kein camel case, sondern pascal case verwendet (wie camel case nur ist der erste Buchstabe auch groﬂ).
*)
